 ...
 * Created on a base of t3lib_xml for using with TYPO3 6.2 February/2016 by Igor Kruglov
 ...
 *
 *
 *   86: class tx_johadvbesearch_t3libxml
 *  102:	 function setTopLevelName($topLevelName)
 ...
 * 
 * This class contains mainly functionality of deprecated t3lib_xml class. That functionality was put here by
 * Igor Kruglov for the needs of upgraded to 6.2 version joh_advbesearch extension.
 *
 * @author	Kasper Skårhøj <kasperYYYY@typo3.com>
 * @author      Igor Kruglov <igkruglov@mail.ru>
 * @package TYPO3
 * @subpackage tx_johadvbesearch
 * @see user_xmlversion, user_wapversion
 */
class tx_johadvbesearch_t3libxml {
	 ...
	 * @return	void
	 */
	function tx_johadvbesearch_t3libxml() {
	 ...
	 * @return	void
	 */
	function setTopLevelName($topLevelName) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/joh_advbesearch/mod1/tx_johadvbesearch_t3libxml.php']) {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/joh_advbesearch/mod1/tx_johadvbesearch_t3libxml.php']);
}
?>